...
- [TLS](tls.md) — encrypts XMPP connections
- [SIP](sip.md) — alternative signaling for voice/video (Jingle is XMPP's equivalent)
- [WebSocket](websocket.md) — browser-based XMPP transport
- [DNS](dns.md) — SRV records for server discovery
