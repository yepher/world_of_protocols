...
- [RADIUS](radius.md) — predecessor AAA protocol
- [LTE](../telecom/lte.md) — the network Diameter was built for
- [5G NR](../telecom/5gnr.md) — 5GC replaces Diameter with HTTP/2-based SBI
