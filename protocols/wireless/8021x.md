...
- [RADIUS](../application-layer/radius.md) — authentication server
- [Kerberos](../application-layer/kerberos.md) — credential source for EAP-TLS/PEAP
- [802.11 (Wi-Fi)](80211.md) — wireless LAN
- [Ethernet](../link-layer/ethernet.md) — wired 802.1X
- [TLS](../application-layer/tls.md) — used inside EAP-TLS/PEAP/TTLS
