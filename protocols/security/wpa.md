...
- [802.11 (Wi-Fi)](../wireless/80211.md) — base Wi-Fi framing and PHY
- [802.1X / EAP](8021x.md) — enterprise authentication framework
- [RADIUS](radius.md) — authentication server for WPA Enterprise
- [Kerberos](kerberos.md) — sometimes used via EAP-FAST/EAP-TLS
