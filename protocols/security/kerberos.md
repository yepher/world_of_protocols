...
- [LDAP](../naming/ldap.md) — directory service Kerberos often authenticates against
- [RADIUS](radius.md) — alternative AAA (often wraps Kerberos via EAP)
- [SMB](../file-sharing/smb.md) — Windows file sharing authenticated via Kerberos
- [DNS](../naming/dns.md) — SRV records for KDC discovery (`_kerberos._tcp.example.com`)
