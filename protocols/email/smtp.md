...
- [TLS](../security/tls.md) — encrypts SMTP connections
- [DNS](../naming/dns.md) — MX record lookup for mail routing; SPF/DKIM/DMARC
- [SMPP](../mobile-sync/smpp.md) — SMS messaging protocol (sometimes bridged with email)
